...
/**
 * Provides necessary meta information about the mbcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class MbCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MbCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.twc.core.hmc.locales";
