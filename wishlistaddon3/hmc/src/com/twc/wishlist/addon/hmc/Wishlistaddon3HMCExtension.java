 ...
 *
 */
package com.twc.wishlist.addon.hmc;
...
/**
 * Provides necessary meta information about the wishlistaddon3 hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.3
 */
public class Wishlistaddon3HMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(Wishlistaddon3HMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.twc.wishlist.addon.hmc.locales";
