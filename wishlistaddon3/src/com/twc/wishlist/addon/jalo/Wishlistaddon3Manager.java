...
/**
 * This is the extension manager of the Wishlistaddon3 extension.
 */
public class Wishlistaddon3Manager extends GeneratedWishlistaddon3Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Wishlistaddon3Manager.class.getName());
	 ...
	 */
	public static Wishlistaddon3Manager getInstance()
	{
		return (Wishlistaddon3Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Wishlistaddon3Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public Wishlistaddon3Manager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Wishlistaddon3Manager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Wishlistaddon3Manager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Wishlistaddon3Manager called, current tenant: " + getTenant().getTenantID());
		}
	}
