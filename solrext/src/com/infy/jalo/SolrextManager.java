...
/**
 * This is the extension manager of the Solrext extension.
 */
public class SolrextManager extends GeneratedSolrextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolrextManager.class.getName());
	 ...
	 */
	public static SolrextManager getInstance()
	{
		return (SolrextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SolrextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolrextManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolrextManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SolrextManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SolrextManager called, current tenant: " + getTenant().getTenantID());
		}
	}
